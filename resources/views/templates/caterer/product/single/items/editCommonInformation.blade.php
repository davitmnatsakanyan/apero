<div flow-init="{
    ...
    <form id="addProduct">
        <div class="profil-form fl">
            <div class="info-box">
                ...
                <ui-select ng-model="product.kitchen" class="fmlreg fz13"
            ...
            <div class="info-box">
                <label for="nem" class="title fmlbold fz17">Name</label>
        ...
        <div class="profil-form fl">
            <div class="info-box">
                ...
                <ui-select ng-model="product.menu" class="fmlreg fz13"
            ...
            <div class="info-box">
                <label for="ingredients" class="title fmlbold fz17">Ingredients</label>
    ...
    <div class="cater-pic image-size2" ng-hide="$flow.files.length">
        <img class="cater-pic-width image-size" src="../images/products/<%product.avatar%>" alt="No image"/>
    </div>

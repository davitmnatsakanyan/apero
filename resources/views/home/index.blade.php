							...
							<form class="clearfix">
								...
								<div class="col-sm-4">
									<div class="anlassgrosse">
										<select name="anlassgrosse" form="anlassgrosse">
								...
								<div class="col-xs-12">
									<div class="finden">
										<a href= {!! url("hillfe") !!} class="btn">Apero-Anbieter finden</a>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged , when an unknown printer took a galley of type and scrambled it to make a type 
specimen book. </p>
					</div>
				</div>
			</div>

										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
                                                                                                        {!! Html::image('administration/assets/img/avatar.png',NULL,['class'=>'img-responsive'])!!}
													<div class="details">
														<div>
															<a href="#">
																 Robert Nilson
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
                                                                                {!! Html::image('administration/assets/img/avatar1.jpg' ,NULL,['class' => 'avatar img-responsive']) !!}     
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
									...
									<li class="out">
                                                                                {!! Html::image('administration/assets/img/avatar2.jpg',NULL, ['class' => 'avatar img-responsive'])!!}     
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
									...
									<li class="out">
                                                                                     {!! Html::image('administration/assets/img/avatar3.jpg' ,NULL,['class' => 'avatar img-responsive']) !!}
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
									...
									<li class="out">
                                                                                     {!! Html::image('administration/assets/img/avatar1_small.jpg' ,NULL,['class' => 'avatar img-responsive']) !!}
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
